...
var board_js_1 = __importDefault(require("../dist/app/javascript/packs/board/board.js"));
var cursor_js_1 = __importDefault(require("../dist/app/javascript/packs/board/cursor.js"));
var anime_es_js_1 = __importDefault(require("animejs/lib/anime.es.js"));
var cells = __importStar(require("../dist/app/javascript/packs/board/cell.js"));
var MAZE_HEIGHT = 15;
var MAZE_WIDTH = 20;
...
function importBoards() {
    ...
    fetch(url)
        ...
        for (var i = 0; i < json.length; i++) {
            var cells_1 = json[i].cells.map(function (x) { return x.cell_type; });
...
function dequeueAnimationQueue() {
    ...
    var animation = anime_es_js_1.default({
...
function animateSolution(solution) {
    var pathFindingAnimeTimeline = anime_es_js_1.default.timeline({
        easing: 'linear',
        autoplay: false,
    });
