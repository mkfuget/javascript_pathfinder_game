    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var Board = function () {
            ...
            _createClass(Board, [{
                    ...
                    key: "aStarSearchWeak",
                    value: function aStarSearchWeak(cursor) {
                        ...
                        var aStarSearchWeak = new _PriorityQueue_js__WEBPACK_IMPORTED_MODULE_1__["default"](aStarSearchWeakComparator);
                        return this.solveMaze(cursor, aStarSearchWeak);
                    }
                }, {
                    key: "aStarSearchStrong",
                    value: function aStarSearchStrong(cursor) {
                        function aStarSearchStrongComparator(cursorA, cursorB) {
                            return cursorA.stepsTaken + 3 * cursorA.board.manhattanDistanceToFinish(cursorA.xIndex, cursorA.yIndex) < cursorB.stepsTaken + 3 * cursorB.board.manhattanDistanceToFinish(cursorB.xIndex, cursorB.yIndex);
                        }
                        var aStarSearchStrong = new _PriorityQueue_js__WEBPACK_IMPORTED_MODULE_1__["default"](aStarSearchStrongComparator);
                        return this.solveMaze(cursor, aStarSearchStrong);
                    }
                }, {
                    key: "indexToXIndex",
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function importBoards() {
            ...
            fetch(url).then(function (response) {
                ...
                document.getElementById('user_levels_button').addEventListener("click", function () {
                    setGameMode('userLevels');
                });
                document.getElementById('base_levels_button').addEventListener("click", function () {
                    setGameMode('baseLevels');
                });
                ;
                document.getElementById('edit_mode_button').addEventListener("click", function () {
                    setGameMode('editMode');
                });
                ;
            });
        }
            ...
            switch (e.key) {
                ...
                case "p":
                    if (document.getElementById('dijkstra').checked) {
                        ...
                        animateSolution(mainBoard.aStarSearchStrong(mainCursor));
                    }
                    break;
                case "x":
...
//# sourceMappingURL=index-08ac5eb7a11c3da65a40.js.map
