    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function setGameMode(mode) {
            switch (mode) {
                case 'baseLevels':
                    gameMode = 'baseLevels';
                    document.getElementById('user_levels_action_bar').style = 'none';
                    document.getElementById('edit_mode_action_bar').style = 'none';
                case 'user_levels':
                    gameMode = 'userLevels';
                case 'editMode':
                    gameMode = 'editMode';
...
//# sourceMappingURL=index-59911f3b8263a9cdbb90.js.map
