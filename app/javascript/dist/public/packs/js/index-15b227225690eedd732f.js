    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function importBoards() {
            ...
            fetch(url).then(function (response) {
                ...
                for (var _i = 0; _i < json.length; _i++) {
                    var _cells = json[_i].cells.map(function (x) {
                        return x.cell_type;
                    });
                    if (json[_i].board_type === "base") {
                        baseLevelCells.push(_cells);
                    }
                    else if (json[_i].board_type === "user") {
        ...
        function addBoard(board, cellArray) {
            ...
            var _loop = function _loop(_i2) {
                var cellId = "cell_" + (j + _i2 * MAZE_WIDTH);
                var mazeCell = document.getElementById(cellId);
                var xIndex = mainBoard.indexToXIndex(_i2);
                var yIndex = mainBoard.indexToXIndex(_i2);
                mazeCell.addEventListener("mouseenter", function () {
                    hoverClickSetCell(board, _i2, j);
                });
                mazeCell.addEventListener("mousedown", function () {
                    clickSetCell(board, _i2, j);
                });
                addCellToBoard(board, cellArray[_i2], xIndex, yIndex);
            };
            for (var _i2 = 0; _i2 < MAZE_HEIGHT * MAZE_WIDTH; _i2++) {
                _loop(_i2);
            }
        }
        function exportBoard(board) {
            var url = 'api/v1/boards';
            var cells = [];
            for (var _i3 = 0; _i3 < board.height; _i3++) {
                for (var _j = 0; _j < board.width; _j++) {
                    cells.push({
                        cell_type: board.boardCells[_i3][_j].type,
                        board_index: board.toBoardIndex(_j, _i3)
                    });
                }
            }
            var boardData = {
        ...
        function animateSolution(solution) {
            ...
            for (var _i4 = 0; _i4 < solution.searchPath.length; _i4++) {
                var currentCursor = solution.searchPath[_i4];
            ...
            for (var _i5 = 0; _i5 < solution.foundPath.length; _i5++) {
                var currentCell = solution.foundPath[_i5];
...
//# sourceMappingURL=index-15b227225690eedd732f.js.map
