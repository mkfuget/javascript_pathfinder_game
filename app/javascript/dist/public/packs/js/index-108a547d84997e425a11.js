...
/******/ (function (modules) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function resetMainCursor(cursor) {
            ...
            document.getElementById('top_left').style.backgroundColor = "none";
            document.getElementById('top_right').style.backgroundColor = "none";
            document.getElementById('bottom_left').style.backgroundColor = "none";
            document.getElementById('bottom_right').style.backgroundColor = "none";
        }
        ...
        function unlockAnimateUnlockCursorKey(value) {
            switch (value) {
                ...
                case 2:
                    ...
                    break;
                case 4:
                    document.getElementById("bottom_left").style.display = "block";
                    break;
                case 8:
...
//# sourceMappingURL=index-108a547d84997e425a11.js.map
