...
/******/ (function (modules) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function resetMainCursor(cursor) {
            ...
            animatedCursor.style.left = "".concat(cursor.xIndex * CELL_WIDTH + START_X_COORDINATE, "px");
            animatedCursor.style.top = "".concat(cursor.yIndex * CELL_WIDTH + START_Y_COORDINATE, "px");
        ...
        function animateSolution(solution) {
            ...
            for (var _i = 0; _i < solution.foundPath.length; _i++) {
                ...
                pathFindingAnimeTimeline.add({
                    targets: _cell,
                    background: _board_cursor_js__WEBPACK_IMPORTED_MODULE_1__["default"].keysUnlockedColor(currentCell.bitMask),
                    duration: 300
                }, '-=150');
            }
        ...
        function toggleDarkMode() {
            ...
            var sidenavLi = sidenavElement.querySelectorAll('li');
            var headLine = sidenavElement.querySelector('.headline');
            if (darkMode) {
                ...
                for (var _i2 = 0; _i2 < sidenavLi.length; _i2++) {
                    sidenavLi[_i2].style.color = "white";
                }
...
//# sourceMappingURL=index-9262ba68448cc2ed8b8d.js.map
