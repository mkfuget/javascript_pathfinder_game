    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function importBoards() {
            ...
            fetch(url).then(function (response) {
                ...
                document.getElementById('user_levels_button').addEventListener("onClick", function () {
                    setMode('userLevels');
                });
                document.getElementById('base_levels_button').addEventListener("onClick", function () {
                    setMode('baseLevels');
                });
                ;
                document.getElementById('edit_mode_button').addEventListener("onClick", function () {
                    setMode('editMode');
                });
                ;
            });
...
//# sourceMappingURL=index-533fdb406eb18bafb831.js.map
