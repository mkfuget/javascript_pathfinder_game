        ...
        function exportBoard(board) {
            ...
            for (var i = 0; i < board.width; i++) {
                for (var j = 0; j < board.height; j++) {
                    _board_cell_js__WEBPACK_IMPORTED_MODULE_4__["push"]({
            ...
            var boardConfigObject = {
                ...
                body: JSON.stringify(boardConfigObject)
            };
            fetch(url, configObject).then(function (resp) {
                return resp.json();
            }).then(function (json) {
...
//# sourceMappingURL=index-5c758c2b37b31b0f0f39.js.map
