        ...
        function setGameMode(mode) {
            ...
            switch (mode) {
                case 'baseLevels':
                    ...
                    baseLevelsButton.style.className = 'selected';
                    userLevelsButton.style.className = 'deselected';
                    editModeButton.style.className = 'deselected';
                    break;
                case 'user_levels':
                    gameMode = 'userLevels';
                    ...
                    editModeActionBar.style.display = 'none';
                    baseLevelsButton.style.className = 'deselected';
                    userLevelsButton.style.className = 'selected';
                    editModeButton.style.className = 'deselected';
                    break;
                case 'editMode':
                    gameMode = 'editMode';
                    ...
                    baseLevelsButton.style.className = 'deselected';
                    userLevelsButton.style.className = 'deselected';
                    editModeButton.style.className = 'selected';
                    break;
            }
        }
...
//# sourceMappingURL=index-0edfba5fb78badc19b51.js.map
