    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        function setGameMode(mode) {
            switch (mode) {
                case 'baseLevels':
                    gameMode = 'baseLevels';
                    document.getElementById('user_levels_action_bar').style.display = 'none';
                    document.getElementById('edit_mode_action_bar').style.display = 'none';
                case 'user_levels':
                    gameMode = 'userLevels';
                case 'editMode':
                    gameMode = 'editMode';
...
//# sourceMappingURL=index-ad5a29ee0c9fd0fd7cef.js.map
